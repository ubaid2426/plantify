...
// import 'package:simple_animations/simple_animations.dart'; // Ensure the package is included in pubspec.yaml

// enum AnimationType { opacity, translateX }

// class RoutAnimation extends StatefulWidget {
//   final CustomAnimationControl controller;  // Specify the type for the controller
//   final double delay;
//   final Widget child;
